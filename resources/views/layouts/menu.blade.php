        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('veiculos.index') }}"><i data-feather="list"></i><span>Veículos</span></a></li>

                    <!--
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href=""><i data-feather="shopping-bag"></i><span>Produtos</span></a></li>
                    -->
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="package"></i></i><span>Estoque</span></a>
                        <ul class="nav-submenu menu-content">
                            <li><a href="">Estoque</a></li>
                            <li><a href="">Entradas</a></li>
                            <li><a href="">Saídas</a></li>
                            <li><a href="">Fornecedores</a></li>
                            <li><a href="">Grandezas</a></li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('montadoras.index') }}"><i data-feather="list"></i><span>Montadoras</span></a></li>
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('modelos.index') }}"><i data-feather="list"></i><span>Modelos de Veículos</span></a></li>
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('categorias-habilitacao.index') }}"><i data-feather="list"></i><span>Categorias de Habilitação</span></a></li>
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('tipos-veiculos.index') }}"><i data-feather="list"></i><span>Tipos de Veículos</span></a></li>
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('situacoes.index') }}"><i data-feather="list"></i><span>Situações</span></a></li>
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{ route('tipos-situacao.index') }}"><i data-feather="list"></i><span>Tipos de Situação</span></a></li>
                    <!--
                    <li class="sidebar-main-title">
                        <div>
                            <h6>General</h6>
