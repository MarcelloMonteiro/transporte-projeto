        ...
        <div class="page-main-header">
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper"><a href="{{ route('dashboard') }}"><img class="img-fluid" src="{{ asset('imagens/logo-dr-home.png') }}" style="height: 30px;" alt=""></a></div>
                ...
                <div class="nav-right col pull-right right-menu p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown p-0">
                            <button class="btn btn-primary-light" type="button"><a href="#" onclick="event.preventDefault(); document.querySelector('form.logout').submit();"><i data-feather="log-out"></i>Sair</a></button>
